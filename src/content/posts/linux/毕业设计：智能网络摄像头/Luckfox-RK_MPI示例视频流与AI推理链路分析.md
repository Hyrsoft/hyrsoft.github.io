---
title: 毕设日志（一） Luckfox RK_MPI示例视频流与AI推理链路分析
...
主要分析 [`luckfox_pico_rtsp_retinaface_osd`](https://github.com/LuckfoxTECH/luckfox_pico_rkmpi_example/blob/kernel-5.10.160/example/luckfox_pico_rtsp_retinaface_osd/src/main.cc)例程，探讨其如何实现摄像头采集、NPU 推理、硬件编码及 RTSP 推流的完整链路。
